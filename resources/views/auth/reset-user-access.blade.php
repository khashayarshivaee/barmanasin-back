    ...
    <section class="identity">
        ...
        <div class="identity-copy">
            ...
            <p>
                ...
                Barmanasin account and company email access.
            </p>
    ...
    <main class="content">
        ...
        <div class="card">
            ...
            @if ($state === 'ready')
                ...
                <p class="lead">
                    Create a new password to restore access
                    to your Barmanasin account.
                </p>
                ...
                <div class="security-note">
                    This recovery link is single-use and expires
                    automatically. Your administrator cannot view
            ...
            @elseif ($state === 'success')
                ...
                <div class="security-note">
                    Any old password will no longer work.
                    Existing persistent login credentials have
                    also been rotated.
                </div>
            ...
            @elseif ($state === 'unavailable')
                ...
                <p class="lead">
                    This account is inactive, suspended or
